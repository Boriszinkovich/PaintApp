...
@property (nonatomic, weak) id <SMPageControlDelegate> theDelegate;
...
- (void)pageControl:(SMPageControl *)thePageControl didReceiveTapAndWillMoveToPageAtIndex:(NSInteger)theIndex;
- (void)pageControl:(SMPageControl *)thePageControl didReceiveTapAndDidMoveToPageAtIndex:(NSInteger)theIndex;
